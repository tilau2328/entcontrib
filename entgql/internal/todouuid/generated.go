...
import (
	...
	"github.com/tilau2328/entcontrib/entgql/internal/todo/ent/schema/durationgql"
	...
	"github.com/tilau2328/entcontrib/entgql/internal/todouuid/ent/schema/uuidgql"
...
"""
interface Node @goModel(model: "github.com/tilau2328/entcontrib/entgql/internal/todo/ent.Noder") {
...
func (ec *executionContext) _GroupEdge_node(ctx context.Context, field graphql.CollectedField, obj *ent.GroupEdge) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return nil, fmt.Errorf(`unexpected type %T from directive, should be *github.com/tilau2328/entcontrib/entgql/internal/todouuid/ent.Group`, tmp)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
