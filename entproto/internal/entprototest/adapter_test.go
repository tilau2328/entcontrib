...
func (suite *AdapterTestSuite) TestValidMessage() {
	...
	suite.Equal("github.com/tilau2328/entcontrib/entproto/internal/entprototest/ent/proto/entpb",
...
func (suite *AdapterTestSuite) TestMessageWithPackageName() {
	...
	suite.Equal("github.com/tilau2328/entcontrib/entproto/internal/entprototest/ent/proto/io/entgo/apps/todo",
		fd.GetFileOptions().GetGoPackage())
}
