...
func (i *CategoryWhereInput) P() (predicate.Category, error) {
	...
	case 0:
		return nil, fmt.Errorf("github.com/tilau2328/entcontrib/entgql/internal/todofed/ent: empty predicate CategoryWhereInput")
	case 1:
...
func (i *TodoWhereInput) P() (predicate.Todo, error) {
	...
	switch len(predicates) {
	case 0:
		return nil, fmt.Errorf("github.com/tilau2328/entcontrib/entgql/internal/todofed/ent: empty predicate TodoWhereInput")
	case 1:
		return predicates[0], nil
	default:
